...
export const PROJECTS: ProjectCard[] = [
  {
    ...
    tech: ['Python', 'MCP', 'OpenAI Agents SDK', 'RAG'],
    type: 'AI',
  ...
  },
  {
    ...
    tech: ['Python', 'Kubernetes', 'Docker', 'FastAPI'],
    type: 'AI',
  ...
  },
  {
    ...
    tech: ['ROS 2', 'Gazebo', 'NVIDIA Isaac', 'Shell'],
    type: 'Robotics',
  ...
  },
  {
    ...
    tech: ['Next.js', 'Sanity CMS', 'Firebase', 'TypeScript'],
    type: 'Full-Stack',
