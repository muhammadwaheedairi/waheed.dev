...
import { Search, Home, User, Briefcase, Code2, GitBranch, Layers, Mail, Github, Linkedin, Command } from 'lucide-react';
...
export default function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    { id: 'services', label: 'Services',      icon: Briefcase, shortcut: 'S', action: () => scrollTo('#services') },
    { id: 'work',     label: 'Work',          icon: Code2,     shortcut: 'W', action: () => scrollTo('#projects') },
    { id: 'process',  label: 'Process',       icon: GitBranch, shortcut: 'P', action: () => scrollTo('#process') },
    { id: 'stack',    label: 'Stack',         icon: Layers,    shortcut: 'T', action: () => scrollTo('#tech') },
    { id: 'contact',  label: 'Contact',       icon: Mail,      shortcut: 'C', action: () => scrollTo('#contact') },
          ...
          >
            ...
            <div className="max-h-[60vh] overflow-y-auto p-2">
              {filtered.length > 0 ? filtered.map((cmd, idx) => (
                ...
                <div className="py-12 text-center text-white/20 font-mono text-sm">
