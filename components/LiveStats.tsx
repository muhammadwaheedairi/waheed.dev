...
const STATS = [
  { label: 'Problems Solved',  value: 54,  suffix: '+', icon: Code2,     color: 'text-primary' },
  { label: 'Hackathons Won',   value: 6,   suffix: '',  icon: Trophy,    color: 'text-secondary' },
  { label: 'Years Building',   value: 2,   suffix: '+', icon: Calendar,  color: 'text-white' },
  { label: 'GitHub Commits',   value: 600, suffix: '+', icon: GitCommit, color: 'text-primary' },
];

const TICKER = [
  'Next.js', 'TypeScript', 'Tailwind CSS', 'Sanity CMS', 'Vercel',
  'Python', 'FastAPI', 'Neon DB', 'OpenAI Agents SDK', 'MCP',
  'Docker', 'Kubernetes', 'Kafka', 'Dapr', 'Oracle Cloud',
  'Claude AI', 'Agent Skills', 'Sub Agents', 'SDD',
];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="mb-16 text-center">
          ...
          <h2 className="text-4xl sm:text-5xl font-black tracking-tighter uppercase mb-3">
            THE WORK <span className="text-gradient">SPEAKS.</span>
          </h2>
          <p className="text-white/30 text-sm font-mono">
            Not claims. Actual numbers from actual projects.
          </p>
        </div>
            ...
            >
              {[...TICKER, ...TICKER, ...TICKER].map((tech, i) => (
                <div key={i} className="flex items-center gap-4">
                  <span className="text-lg sm:text-xl font-bold text-white/20 hover:text-primary transition-colors cursor-default">
                    {tech}
                  </span>
